...
public class KeyMazeSolver {
     ...
     *
     * @param map The 2D grid representing the maze.
     * @return The minimum number of moves, or -1 if it's impossible.
     */
    public static int findMinimumMovesToExit(String[] map) {
        int rows = map.length;
    ...
    public static void main(String[] args) {
        ...
        int result = findMinimumMovesToExit(grid);
